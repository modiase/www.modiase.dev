...
var app = (function () {
    ...
    /* src/components/common/Card/Simple.svelte generated by Svelte v3.31.1 */

    const file = "src/components/common/Card/Simple.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*messages*/ 2 && t_value !== (t_value = /*message*/ ctx[2] + "")) set_data_dev(t, t_value);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let { title } = $$props;
    	let { messages } = $$props;
    	const writable_props = ["title", "messages"];
    	...
    	$$self.$capture_state = () => ({ title, messages });
    ...
    class Simple extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { title: 0, messages: 1 });
    		...
    		if (/*title*/ ctx[0] === undefined && !("title" in props)) {
    			console.warn("<Simple> was created without expected prop 'title'");
    		}

    		if (/*messages*/ ctx[1] === undefined && !("messages" in props)) {
    			console.warn("<Simple> was created without expected prop 'messages'");
    		}
    	}
    ...
    function create_fragment$1(ctx) {
    	...
    	simplecard = new Simple({
    			props: {
    				title: placeholderCardTitle,
    				messages: /*placeholderCardMessages*/ ctx[0]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			create_component(simplecard.$$.fragment);
    			attr_dev(main, "class", "svelte-uoirmu");
    			add_location(main, file$1, 5, 0, 272);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(simplecard, main, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(simplecard.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(simplecard.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(main);
    			destroy_component(simplecard);
    		}
    	};
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const placeholderCardMessages = [
    		"Hello! My site is currently undergoing a redesign.",
    	...
    	$$self.$capture_state = () => ({
    		...
    		placeholderCardMessages
    	});

    	return [placeholderCardMessages];
    }
