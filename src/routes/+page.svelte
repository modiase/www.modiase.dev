      ...
      >
        <div class="flex flex-col gap-8">
          ...
          <section>
            ...
            <p>
              I have worked in a number of roles within consulting and software engineering and am <em
                >equally enthusiastic about working with code and other people</em
              >. I prefer to work at <em>mission driven organisations</em> and typically try to give
              as much of myself to my work as I am healthily able to since I believe that
              <em>a good life is one lived in service to others</em>. For a fuller listing of my
              experience, please refer to my <Link
